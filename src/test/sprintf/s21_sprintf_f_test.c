...
// END_TEST
//
// START_TEST(s21_sprintf_spec_f_mass_test) {
//   char str1[256];
//   char str2[256];
//
...
//                           inf, inf, inf);
//   int read2 =
//       sprintf(str2, "%f %+f % f %05f %.0f %.10f", inf, inf, inf, inf, inf,
//       inf);
//   ck_assert_int_eq(s21_strcmp(str1, str2), 0);
//   ck_assert_int_eq(read1, read2);
// }
...
//                           nan, nan, nan);
//   int read2 =
//       sprintf(str2, "%f %+f % f %05f %.0f %.10f", nan, nan, nan, nan, nan,
//       nan);
//   ck_assert_int_eq(s21_strcmp(str1, str2), 0);
//   ck_assert_int_eq(read1, read2);
// }
...
TCase *case_s21_sprintf_f(void) {
  ...
  // tcase_add_test(tc_f, s21_sprintf_spec_f_mass_test);
