...
Suite *suite_s21_sprintf_test(void) {
  ...
  tcase_add_test(tc, s21_sprintf_spec_c_empty_char);
  tcase_add_test(tc, s21_sprintf_spec_c_empty_char_wid);
  tcase_add_test(tc, s21_sprintf_spec_c_empty_wchar);
  tcase_add_test(tc, s21_sprintf_spec_c_empty_wchar_wid);
